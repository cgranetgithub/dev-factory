...
PR_LABEL = "devfactory"
# Where the factory lives. Cited in every pull request it opens, so it must be a
# real address — the placeholder it replaced was a 404 in every PR for months.
PROJECT_URL = "https://github.com/cgranetgithub/dev-factory"
...
def _build_pr_body(ctx: PipelineContext) -> str:
    ...
    lines += [
        "---",
        f"_Generated by [DevFactory]({PROJECT_URL}) 🤖_",
    ]
